  ...
  <?php include "../partials/header.php";
    $countGuru = mysqli_query($koneksi, "SELECT COUNT(id) as jumlah_guru
    FROM guru");

    $countGuru = mysqli_fetch_array($countGuru);

    $countSiswa = mysqli_query($koneksi, "SELECT COUNT(id) as jumlah_siswa
    FROM siswa");
                      ...
                      <div class="col-lg-6 col-md-12 col-6 mb-4">
                          <div class="card">
                              <div class="card-body">
                                  ...
                                  <h3 class="card-title mb-2"><?= $countGuru['jumlah_guru'] ?> </h3>
                      ...
                      <div class="col-lg-6 col-md-12 col-6 mb-4">
                          <div class="card">
                              <div class="card-body">
                                  ...
                                  <h3 class="card-title mb-2"><?= $countSiswa['jumlah_siswa'] ?></h3>
